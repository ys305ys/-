...
(function() {
    ...
    if(website_host=="pan.baidu.com" || website_host=="yun.baidu.com"){
		...
		if (location.href.indexOf('baidu.com/s/') > 0) {//v5
			...
			$('<a class="g-button" style="background-color:#fff;z-index:999;" href="' + url + '" title="转到 Pandownload 网页版"><span class="g-button-right"><em class="icon icon-picpre-download" style="color:#d60;"><font color="#090"></em><span class="text" style="width: auto;"><font color="#090">Pandownload</font></span></span></a>').insertBefore('.x-button-box a.g-button[data-button-id=b3]');
